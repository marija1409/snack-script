...
public class SnackScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "STRING", "ESC", "TRUE", "FALSE", "NUM", 
			"BOOL", "LINE", "ARRAY", "PRINT", "INPUT", "IF", "ELSE", "WHILE", "FOR", 
			"FUN", "RETURN", "AND", "OR", "LEFT_PAREN", "RIGHT_PAREN", "CARET", "STAR", 
			"SLASH", "PLUS", "MINUS", "ARRAY_OPEN", "ARRAY_CLOSE", "COMMA", "EQUAL", 
			"LESS", "GREATER", "LESS_EQUAL", "GREATER_EQUAL", "EQUAL_EQUAL", "NOT_EQUAL", 
			"PLUS_PLUS", "MINUS_MINUS", "DIGIT", "NZERO", "NUMBER", "IDENTIFIER", 
			"SPACES", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	public SnackScriptLexer(CharStream input) {
		super(input);
